  ...
  return defineConfig({
    ...
    resolve: {
      alias: {
        ...
        '@grassland': path.join(process.cwd(), './src/theme/grassland'),
        '@purple': path.join(process.cwd(), './src/theme/purple'),
        '@lightRed': path.join(process.cwd(), './src/theme/lightRed'),
        '@darkGreen': path.join(process.cwd(), './src/theme/darkGreen'),
      },
    },
    server: {
      host: '0.0.0.0',
